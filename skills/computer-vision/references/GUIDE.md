...
This guide provides comprehensive documentation for the **computer-vision** skill in the custom-plugin-machine-learning plugin.
...
```bash
# Invoke the skill
claude "computer-vision - [your task description]"

# Example
claude "computer-vision - analyze the current implementation"
```
...
def implement_computer_vision(input_data):
    """
    Implement computer-vision functionality.
