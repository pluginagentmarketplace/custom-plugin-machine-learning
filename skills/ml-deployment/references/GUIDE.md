...
This guide provides comprehensive documentation for the **ml-deployment** skill in the custom-plugin-machine-learning plugin.
...
```bash
# Invoke the skill
claude "ml-deployment - [your task description]"

# Example
claude "ml-deployment - analyze the current implementation"
```
...
def implement_ml_deployment(input_data):
    """
    Implement ml-deployment functionality.
