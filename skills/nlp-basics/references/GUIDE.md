...
This guide provides comprehensive documentation for the **nlp-basics** skill in the custom-plugin-machine-learning plugin.
...
```bash
# Invoke the skill
claude "nlp-basics - [your task description]"

# Example
claude "nlp-basics - analyze the current implementation"
```
...
def implement_nlp_basics(input_data):
    """
    Implement nlp-basics functionality.
