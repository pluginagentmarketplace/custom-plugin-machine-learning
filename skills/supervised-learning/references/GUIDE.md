...
This guide provides comprehensive documentation for the **supervised-learning** skill in the custom-plugin-machine-learning plugin.
...
```bash
# Invoke the skill
claude "supervised-learning - [your task description]"

# Example
claude "supervised-learning - analyze the current implementation"
```
...
def implement_supervised_learning(input_data):
    """
    Implement supervised-learning functionality.
