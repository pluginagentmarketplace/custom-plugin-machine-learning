...
This guide provides comprehensive documentation for the **clustering** skill in the custom-plugin-machine-learning plugin.
...
```bash
# Invoke the skill
claude "clustering - [your task description]"

# Example
claude "clustering - analyze the current implementation"
```
...
def implement_clustering(input_data):
    """
