# Ml Fundamentals Guide

## Overview

This guide provides comprehensive documentation for the **ml-fundamentals** skill in the custom-plugin-machine-learning plugin.
...
```bash
# Invoke the skill
claude "ml-fundamentals - [your task description]"

# Example
claude "ml-fundamentals - analyze the current implementation"
```
...
def implement_ml_fundamentals(input_data):
    """
    Implement ml-fundamentals functionality.
