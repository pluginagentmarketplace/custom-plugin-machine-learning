...
This guide provides comprehensive documentation for the **deep-learning** skill in the custom-plugin-machine-learning plugin.
...
# Example
claude "deep-learning - analyze the current implementation"
```
